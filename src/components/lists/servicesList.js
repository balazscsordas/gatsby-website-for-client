const services = [
  {
    ...
    treatments: [
...

      {
        ...
        treatmentDescription: "A Peptides kiskezelésnek köszönhetően a bőr hidratáltsága fokozódik, a bőr energetizált, üde és friss lesz. Javul az arcbőr oxigén és tápanyag ellátottsága, bársonyos tapintású lesz. Személyre szabott kezelés vízhiányos, fakó, problémás bőrtípusra egyaránt.",
...

      {
        ...
        treatmentDescription: "Szakadj ki a hétköznapok rohanásából és töltődj fel a mindössze 35 perces frissítő Kóstoló kezeléssel!",
...

  {
    ...
    treatments: [
...

      {
        ...
        treatmentPlusDescription: "Ultrahangos hatóanyag bevitellel, nyak és dekoltázsápolással:",
...

      {
        ...
        treatmentDescription: "Maximális hidratálás és ápolás a dehidratált,száraz, érzékeny bőrre. A vízhiányos bőr gyakran érzékennyé válik mivel természetes védelmi funkciója megbomlik. A bőr felszíne érdessé válhat, kellemetlen feszülés és bőrpír is kísérheti. Az Aqua Genomics termékcsalád a bőr legmélyebb rétegében, gén szinten fejti ki mélyhidratáló hatását. Stimulálja a bőrben a természetes hidratáló faktorokat, lelassítja a vízvesztés folyamatát. A kezelések hatására a bőr visszanyeri rugalmasságát és puha tapintású lesz. Bőrérzékenység esetén megszünteti a kellemetlen feszülést, viszketést, helyreállítja a bőr természetes védőrétegét és késlelteti az öregedési folyamatokat. A fakó bőr újra visszanyeri természetes fényét.",
        treatmentPrice: "13500 Ft",
        treatmentTime: "60 perc",
        treatmentSteps: [
          "Letisztítás",
...

  {
    ...
    image: "../images/Relax_img.jpg",
    treatments: [
      {
        treatmentName: "Wando Face Yoga tónusfokozó masszázs",
        treatmentDescription: "A wando protokoll az arc-, nyak-, és dekoltázs teljeskörű masszázsa, kiemelten a szem-, és ajak terület feszesítését szolgálja, oldja a mimikai ráncokat okozó izom feszültséget, pihenteti az ajkak és a szem izmait ami késlelteti a ráncok megjelenését. Beindítja a szemkörnyék mikrocirkulációját így a karikás, ödémás szemkörnyékre jótékony hatást fejt ki. A kézzel, illetve az eszközzel történő masszázs meghatározott menetben váltakoznak és adnak akupresszúrás hatást, nyirokműködés segítést, izomműködés harmonizálást és kellemes, pihentető énidőt egyben.",
        treatmentPrice: "9500 Ft",
        treatmentTime: "60 perc",
        treatmentSteps: [
          "Az arc gyengéd megtisztítása a szennyeződésektől",
          "A bőr PH egyensúlyának visszaállítása",
          "Arcradírozás puhává, simává és egyenletesebbé téve a bőrt",
          "Értékes ásványi anyagokban gazdag peptides szérum felvitele",
          "Teljeskörű arc és dekoltázsmasszázs szintetikumoktól mentes tápláló Bio Chia masszázsolajjal",
          "Szem és az ajak környékének tónus fokozása face yoga eszközzel",
          "Befejező ápolás"
        ]
      },
  ...
  {
    name: "Gyantázás",
    image: "../images/Gyantazas_kezeles_img.jpg",
    treatments: [
      {
...

  {
    ...
    image: "../images/szempilla_img.jpg",
    treatments: [
      {
        treatmentName: "Klasszikus szempilla építés",
        treatmentDescription: "Azoknak a hölgyeknek ajánlott, akik nem akarnak művi hatást keltő műszempillákat, inkább a lágyabb, természetesebb hatást részesítik előnyben. A különböző stylingok segítségével optikailag formázhatjuk a szemet, megnyitja a tekintet.",
        treatmentPrice: "7500 Ft (bevezető ár)",
        treatmentTime: "90-120 perc",
        treatmentSteps: ""
      },

      {
        treatmentName: "Szempilla lifting",
        treatmentDescription: "A szempilla lifting azoknak a hölgyeknek ajánlott akik természetes, íves és hosszabbnak tűnő pillákra vágynak műszempilla felrakása nélkül. A szempilla liftinggel egybekötött szempillafestés eredményeként egy gyönyörű keretet kap a szem, kiemeli azt. A végeredmény egy üde, fiatalos és nyitottabb tekintet. A kezelés során a szempillákat egy speciális szérummal kezeljük ami a tövénél emeli meg a szempillákat, extrán ívelt görbületet eredményez. Az eredmény 6-8 hétig tartós.",
        treatmentPrice: "9000 Ft",
        treatmentTime: "60 perc",
        treatmentSteps: [
...

      {
        ...
        treatmentDescription: "A szempillafestés eredménye a hangsúlyos és gyönyörű szempilla mely kiemeli a szemet. Rendkívül praktikus mert nem kell minden nap spirálozni a szempillákat! Hatását 4-5 hétig élvezhetjük!",
      ...
      },
      {
        ...
        treatmentDescription: "A szemöldök az arc meghatározó része, hiszen nem csak keretezi, hanem az arc teljes karakterét is meghatározza. A tartós szemöldökfestés azoknak a vendégeknek ajánlott akiknek halványabb a szemöldökének színe, ki szeretnék emelni azt.",
      ...
      },
      {
        ...
        treatmentDescription: "Egy teljesen új forma kialakítása történik, mikor a teljesen kinőtt vagy még sosem szedett szemöldök formázása történik.",
...

  {
    ...
    treatments: [
...

      {
        ...
        treatmentDescription: "A Callux kiskezelés egy lágyító hab formula révén fejti ki hatását. Intenzíven puhítja a bőrkeményedést, megkönnyíti annak szike nélküli eltávolítását. A bőr sima,puha és selymes lesz tapintású, javul a láb komfortérzete. Ajánlott Callux nagykezelés után szintentartásként, normál, nem túl problémás lábakra.",
        treatmentPrice: "6500 Ft",
        treatmentTime: "45 perc",
        treatmentSteps: [
