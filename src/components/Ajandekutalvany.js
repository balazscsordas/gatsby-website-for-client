            ...
            <Container>
                ...
                <Row>
                    ...
                    <Col lg={6}>
                        ...
                        <p className="index-about-me-text">A kozmetikai ajándékkártya kiváló meglepetés szeretteidnek minden alkalomra  legyen szó születésnapról, névnapról, évfordulóról, vagy más jeles alkalmakról.  Válogass a relax élményt nyújtó regeneráló, fiatalító kezelések  kezelések között. Az ajándékkártyát lehetőséged van tetszőleges összeggel feltölteni, ha nem tudod eldönteni minek is örülnének a legjobban.
                        </p>
                    </Col>
                </Row>
            </Container>
